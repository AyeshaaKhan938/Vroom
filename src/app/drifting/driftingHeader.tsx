...
export default function DriftingHeader() {
  ...
  return (
    <section className="relative w-full h-[60vh] md:h-[90vh] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/images/drifting.png')" }}
      />
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-6 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center">
         ...
         Drifting Experience Registration
          </h1>
          <p className="text-white/85 max-w-3xl button-font text-sm md:text-base">
          Master the art of controlled chaos with professional instruction, modified drift cars, and
comprehensive training sessions designed to unleash your inner drift champion.
          </p>
        </div>
