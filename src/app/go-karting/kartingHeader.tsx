...
export default function KartingHeader() {
  ...
  return (
    <section className="relative w-full h-[60vh] md:h-[90vh] overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/images/karting.png')" }}
      />
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-6 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center">
         ...
         Go Karting Registration
          </h1>
          <p className="text-white/85 max-w-3xl button-font text-sm md:text-base">
           Experience the thrill of speed in our professional go-karting facility. Book your
adrenaline-filled session today.
          </p>
        </div>
